...
public class WhatsappController {
    ...
    public int createMessage(@RequestParam("msg") String content){
    ...
    public String findMessage(@RequestBody Date start, @RequestBody Date end, @RequestParam("K") int K) throws Exception{
        //This is a bonus problem and does not contains any marks
